...
useSeoMeta({
  title: 'web-have-sounds - Procedural Web Audio Engine',
  ...
  ogImage: 'https://web-have-sounds.taohq.org/og-image.svg',
  ...
  twitterImage: 'https://web-have-sounds.taohq.org/og-image.svg',
...
<style>
/* Global resets or variables if any */
</style>
